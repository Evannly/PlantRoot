...
BOOST_PYTHON_MODULE(RootsTool)
{
	...
	class_<BMetaGraph>("mgraph")
		.def("getMode", &BMetaGraph::getMode)
		.def("setMode", &BMetaGraph::setMode)
		...
		.def("showHideEndpoints", &BMetaGraph::showHideEndpoints)
		.def("showHideJunctions", &BMetaGraph::showHideJunctions)
		...
		.def("showHideStem", &BMetaGraph::showHideStem)
		//.def("setDisplayPrimaryNodes", &BMetaGraph::setDisplayPrimaryNodes)
		.def("showHideWhorl", &BMetaGraph::showHideWhorl)
		.def("setDisplayClusterInput", &BMetaGraph::setDisplayClusterInput)
		.def("setDisplayTracingPrimaryBranches", &BMetaGraph::setDisplayTracingPrimaryBranches)
		.def("setDisplayTracingTree", &BMetaGraph::setDisplayTracingTree)
		...
		.def("selectStemTopNode", &BMetaGraph::selectStemTopNode)
		.def("selectStemBottomNode", &BMetaGraph::selectStemBottomNode)
		.def("selectStemPrimaryNode", &BMetaGraph::selectStemPrimaryNode)
		.def("selectWhorl", &BMetaGraph::selectWhorl)
		.def("whorlSelectionValid", &BMetaGraph::whorlSelectionValid)
		.def("addWhorl", &BMetaGraph::addWhorl)
		.def("deleteWhorl", &BMetaGraph::deleteWhorl)
		.def("selectWhorlUpperBound", &BMetaGraph::selectWhorlUpperBound)
		.def("selectWhorlLowerBound", &BMetaGraph::selectWhorlLowerBound)
